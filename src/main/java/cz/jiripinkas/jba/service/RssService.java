...
public class RssService {
	...
	public List<Item> getItem(File file) throws RssException {
		return getItem(new StreamSource(file));
	}

	public List<Item> getItem(String url) throws RssException {
		return getItem(new StreamSource(url));
	}

	private List<Item> getItem(Source source) throws RssException {
